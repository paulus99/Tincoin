...
Tincoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 9859.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 9858 for connections and services them.
...
However, in open source software such as Tincoin Core, where everyone uses
...
pay attention to for reviewers of Tincoin Core code.

General Tincoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Tincoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
