    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Tincoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Tincoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and tincoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Tincoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Tincoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Tincoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Tincoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Tincoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a tincoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Tincoin Core help message to get a list with possible Tincoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Tincoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Tincoin network", "", count));
    } else {
...
{
    QString strTitle = tr("Tincoin Core"); // default title
