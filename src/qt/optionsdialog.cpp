    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("TINCOIN-light"), QVariant("light"));
    ui->theme->addItem(QString("TINCOIN-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("TINCOIN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("TINCOIN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("TINCOIN-traditional"), QVariant("trad"));
